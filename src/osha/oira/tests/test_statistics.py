...
class TestStatistics(unittest.TestCase):
    ...
    def __test(self, context):
        ...
        file_format_vocab = getUtility(IVocabularyFactory,
            ...
            for period in period_vocab._terms:
                ...
                for rtype in type_vocab._terms:
                    ...
                    for year in year_vocab._terms:
                        year = year.value
                        for file_format in file_format_vocab._terms:
                            ...
                            if period > 12:
                                ...
                                month = period
                            filename = statistics.StatisticsMixin.filename[
                                rtype]
