...
_(
    u"Are you sure you want to delete this measure? This action can not be reverted.",
    default=u"Are you sure you want to delete this measure? This action can not be reverted.",  # noqa: E501
)
_(
    u"The current text in the fields 'Action plan', 'Prevention plan' and 'Requirements' of this measure will be overwritten. This action cannot be reverted. Are you sure you want to continue?",  # noqa: E501
    default=u"The current text in the fields 'Action plan', 'Prevention plan' and 'Requirements' of this measure will be overwritten. This action cannot be reverted. Are you sure you want to continue?",  # noqa: E501
)
_(u"Standard solutions")

# More copied translations from euphorie
_(
    u"help_evaluation_optional",
    default=u"This option allows users to skip the evaluation phase.",
)
