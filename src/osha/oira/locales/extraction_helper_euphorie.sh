...
msgmerge -U -N --backup=off hr/LC_MESSAGES/euphorie.po euphorie.pot
...
msgmerge -U -N --backup=off $EUPHORIE_LOCALES/hr/LC_MESSAGES/euphorie.po $EUPHORIE_LOCALES/euphorie.pot
...
cp hr/LC_MESSAGES/euphorie.po $OUTPUT_DIR/osha.oira.hr.po
...
./copyExistingTranslations.py $OUTPUT_DIR/osha.oira.hr.po euphorie.pot $EUPHORIE_LOCALES/hr/LC_MESSAGES/euphorie.po
...
./findDirtyTranslations.py $OUTPUT_DIR/osha.oira.hr.po euphorie.pot --untranslated --fuzzy --output=$OUTPUT_DIR/osha.oira.hr.po
...
./findDirtyTranslations.py $EUPHORIE_LOCALES/hr/LC_MESSAGES/euphorie.po $EUPHORIE_LOCALES/euphorie.pot  --untranslated --debug --fuzzy --output=$TMP_DIR/euphorie.hr.XX.po --noprefill
...
./getNewEntries.py hr/LC_MESSAGES/euphorie.po $TMP_DIR/euphorie.hr.XX.po $OUTPUT_DIR/euphorie.hr.po --ignore-translated
